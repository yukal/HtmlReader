...
describe('Interface', () => {
  ...
  it('flushResults()', () => {
    parser._storage = undefined;
    parser._results = undefined;
    parser._lastSavedPin = undefined;
    parser._lastGivenPin = undefined;
    parser._lastGivenItem = undefined;
